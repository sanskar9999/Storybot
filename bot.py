...
story = [
    ...
    {
        "text": "You wait until morning, but, as the rosy wisps of dawn begin to light the eastern sky, a chill and forbidding wind begins to blow.If you seek shelter, turn to page 6.If you brave the freezing wind to see more of the world about you, tum to page 16.",
        "options": {
    ...
    {
        "text": "\"I know it sounds strange, Your Majesty,\" you say, \"but I have no reason to incur your wrath by making up a false story.\" The King looks around at his courtiers. They all have grave expressions on their faces, as if you have committed some unpardonable sin. Turn to page 11.",
        "options": {
            "\U0001F1E6": "..."
        },
        "images": []
